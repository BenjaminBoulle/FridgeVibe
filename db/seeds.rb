...
recipe13 = Recipe.create!(name: "Pasta basil",
                          ingredients: "Pasta,Olive oil,Basil",
                          user: user_admin,
                          author: "bob",
                          cuisine: "don't know",
                          cook_time: 15,
...
recipe14 = Recipe.create!(name: "Salmon Omelette ",
                          ingredients: "Egg,Olive oil,Salmon,Butter",
                          user: user_admin,
                          author: "bob",
                          cuisine: "don't know",
                          cook_time: 15,
...
recipe15 = Recipe.create!(name: "Frites de Sweet Potatoes",
                          ingredients: "Sweet potatoes,Olive oil,Mayonnaise",
                          user: user_admin,
                          author: "bob",
                          cuisine: "don't know",
                          cook_time: 15,
...
recipe16 = Recipe.create!(name: "Grilled Cheese Sandwich",
                          ingredients: "Bread,Butter,Cheddar",
                          user: user_admin,
                          author: "bob",
                          cuisine: "don't know",
                          cook_time: 15,
...
recipe17 = Recipe.create!(name: "Fondue un peu speciale",
                          ingredients: "Cheddar,Parmesan,American cheese,Butter,Mayonnaise,Bread,Pasta",
                          user: user_admin,
                          author: "bob",
                          cuisine: "don't know",
                          cook_time: 15,
